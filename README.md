...
- *Meta Project Aria Generation 1*:
  ...
  - Open the [`meta_aria_gen1_exporter.py`](https://github.com/dcnieho/glassesTools/tree/master/tools/meta_aria_gen1_exporter.py) script
    and set the variable `vrs_file` to the full path to the recording's `.vrs` file. By default, it is assumed that the recording's
    `.vrs` file and the MPS results are in the same folder and have the default names used by Aria Studio, e.g.
  ...
  - Run the script (ensure you have the right packages installed, see the comment atop the script). An export of the recording will
    be made in a format that can be read by glassesTools and by default stored in the folder `somefolder/export_recording`. If you
...
|`meta_aria_gen1()`|<ol><li>[`output_dir`](#common-input-arguments)</li><li>[`source_dir`](#common-input-arguments)</li><li>[`rec_info`](#common-input-arguments): Optional.</li><li>[`copy_scene_video`](#common-input-arguments): Optional, default `True`.</li><li>[`source_dir_as_relative_path`](#common-input-arguments): Optional, default `False`.</li></ol>|Import a Meta Project Aria Generation 1 recording to a subdirectory of `output_dir`. Does nothing if `source_dir` does not contain a Meta Project Aria Generation 1 recording prepared according to the instructions [here](#required-preprocessing-outside-glassestools).|
|`pupil_core()`|<ol><li>[`output_dir`](#common-input-arguments)</li><li>[`source_dir`](#common-input-arguments)</li><li>[`rec_info`](#common-input-arguments): Optional.</li><li>[`copy_scene_video`](#common-input-arguments): Optional, default `True`.</li><li>[`source_dir_as_relative_path`](#common-input-arguments): Optional, default `False`.</li></ol>|Import a Pupil Core recording to a subdirectory of `output_dir`. Does nothing if `source_dir` does not contain a Pupil Core recording prepared according to the instructions [here](#required-preprocessing-outside-glassestools).|
|`pupil_invisible()`|<ol><li>[`output_dir`](#common-input-arguments)</li><li>[`source_dir`](#common-input-arguments)</li><li>[`rec_info`](#common-input-arguments): Optional.</li><li>[`copy_scene_video`](#common-input-arguments): Optional, default `True`.</li><li>[`source_dir_as_relative_path`](#common-input-arguments): Optional, default `False`.</li></ol>|Import a Pupil Invisible recording to a subdirectory of `output_dir`. Does nothing if `source_dir` does not contain a Pupil Invisible recording prepared according to the instructions [here](#required-preprocessing-outside-glassestools).|
|`pupil_neon()`|<ol><li>[`output_dir`](#common-input-arguments)</li><li>[`source_dir`](#common-input-arguments)</li><li>[`rec_info`](#common-input-arguments): Optional.</li><li>[`copy_scene_video`](#common-input-arguments): Optional, default `True`.</li><li>[`source_dir_as_relative_path`](#common-input-arguments): Optional, default `False`.</li></ol>|Import a Pupil Neon recording to a subdirectory of `output_dir`. Does nothing if `source_dir` does not contain a Pupil Neon recording prepared according to the instructions [here](#required-preprocessing-outside-glassestools).|
